...
class TableColumnTypesTest(unittest.TestCase):
    ...
    def test_col_type(self):
        tt = TableColumnTypes({'a': {'id': 'int', 'val': 'string', 'val_decimal': 'decimal(10, 2)', 'val_bool': 'boolean',
                                     'val_map': 'map<string, string>', 'val_date': 'date', 'val_unknown': 'unknown',
                                     'val_complicated': 'struct<latest_value:string,first_show_time:timestamp>',
                                     'val_list': 'array<string>', 'val_list_int': 'array<int>'}},
                              {'pt': 'string', 'data_date': 'string'}, 'spark')
        ...
        self.assertEqual(tt.cast_as_type('a', 'val_complicated', 'a|2021-01-01'),
        ...
        tt = TableColumnTypes({'a': {'id': 'Int32', 'val': 'String', 'val_list': 'Array<String>', 'unsupported': 'Nested(...)'}},
                              {'pt': 'String'}, 'clickhouse')
        self.assertEqual(tt.get_col_type('a', 'pt'), 'String')
