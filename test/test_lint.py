...
backend = RdbBackend('bigquery://',
                     ...
                     sql_expr=sql_expr,check_only=True)
...
sql_processor = SqlProcessor(backend, sql, [], variables={},
                             report_hdfs_path=None, report_task_id='1',
                             report_es_url=None, report_es_index_prefix=None,
